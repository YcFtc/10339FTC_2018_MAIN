...
public class CustomGoldAlignDetector extends DogeCVDetector {
     ...
     * Simple constructor
     */
    public CustomGoldAlignDetector() {
        super();
        detectorName = "Custom Gold Align Detector"; // Set the detector name
    }
